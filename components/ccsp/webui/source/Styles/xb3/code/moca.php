    ...
    <div class="module forms enable">
		...
		<div class="form-row odd">
			...
			<span id="network_controller_mac" class="readonlyValue"><?php
				...
				if(getStr("Device.MoCA.Interface.1.NetworkCoordinator") == getStr("Device.MoCA.Interface.1.NodeID")){
					echo getStr("Device.MoCA.Interface.1.MACAddress");
				} else {
					echo getStr("Device.MoCA.Interface.1.X_CISCO_NetworkCoordinatorMACAddress");
				}
			?></span>
		</div>
