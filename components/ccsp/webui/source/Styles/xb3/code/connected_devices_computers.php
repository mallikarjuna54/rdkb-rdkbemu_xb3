...
<div id="content"  class="cnt-device-main">
	...
	<div  class="module forms data div-xhs-network" style="position:relative; top:10px; ">
      	<h2>Online Devices-XHS <?php echo $xhsSSIDName; ?> SSID</h2>
      	<table   class="data" summary="this table displays online devices connected to Home security SSID">
      		<tr>
      			<th id="XHS-host-name" width="30%">Host Name</th>
      			<th id="XHS-ipv4-address" width="25%">IPV4 Address</th>
      			<th id="XHS-rssi-level" width="20%">RSSI Level</th> 
      			<th id="XHS-mac-address" width="25%">MAC Address</th>
      			<th id="XHS-disconnect-button" width="20%"></th>
      		</tr>
			...
			for ($i=0; $i < $onXHS_clients_num; $i++) { 
      		...
      		<tfoot>
				<tr class="acs-hide">
					<td headers="XHS-host-name">null</td>
					<td headers="XHS-ipv4-address">null</td>
					<td headers="XHS-rssi-level">null</td>
					<td headers="XHS-mac-address">null</td>
					<td headers="XHS-disconnect-button">null</td>
				</tr>
			</tfoot>
	...
	<div  class="module forms data div-xhs-network" style="position:relative; top:10px; ">
      	<h2>Offline Devices-XHS <?php echo $xhsSSIDName; ?> SSID</h2>
      	<table   class="data" summary="this table displays offline devices connected to Home security SSID">
      		<tr>
      			<th id="offXHS-host-name" width="">Host Name</th>
      			<th id="offXHS-ipv4-address" width="">IPV4 Address</th>
      			<th id="offXHS-mac-address" width="">MAC Address</th>
      			<th id="offXHS-disconnect-button" width=""></th>
      		</tr>
      		...
      		<tfoot>
				<tr class="acs-hide">
					<td headers="offXHS-host-name">null</td>
					<td headers="offXHS-ipv4-address">null</td>
					<td headers="offXHS-mac-address">null</td>
					<td headers="offXHS-disconnect-button">null</td>
				</tr>
			</tfoot>
    ...
    <div  class="module forms data div-pub-network" style="position:relative; top:10px; ">
      	...
      	<table   class="data" summary="this table displays online devices connected to xfinitywifi SSID">
      		...
      		<tfoot>
				<tr class="acs-hide">
					<td headers="xfinitywifi-host-name">null</td>
					<td headers="xfinitywifi-ipv4-address">null</td>
					<td headers="xfinitywifi-rssi-level">null</td>
					<td headers="xfinitywifi-mac-address">null</td>
					<td headers="xfinitywifi-disconnect-button">null</td>
				</tr>
			</tfoot>
