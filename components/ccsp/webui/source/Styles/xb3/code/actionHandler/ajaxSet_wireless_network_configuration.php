...
else if ("mac_ssid" == $arConfig['target'])
{
	...
	{
		$ft[$j][0] = getStr("Device.WiFi.AccessPoint.$i.X_CISCO_COM_MacFilterTable.$k.DeviceName");
		$ft[$j][1] = getStr("Device.WiFi.AccessPoint.$i.X_CISCO_COM_MacFilterTable.$k.MACAddress");
		$k++;
	}
